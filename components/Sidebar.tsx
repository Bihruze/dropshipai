...
const Sidebar: React.FC = () => {
  const { view, setView, orders, logout } = useStore();
  ...
  return (
    <div className="w-64 bg-white h-screen sticky top-0 flex flex-col border-r border-gray-200">
      {/* Logo */}
      ...
      <nav className="flex-1 p-4 space-y-1">
        {menuItems.map((item) => {
          const isActive = view === item.id ||
            (view === 'inventory' && item.id === 'products') ||
            (view === 'studio' && item.id === 'ai-content') ||
            (view === 'product-edit' && item.id === 'products') ||
            (view === 'product-new' && item.id === 'products') ||
            (view === 'agent-dashboard' && item.id === 'agents');
          return (
            <button
              key={item.id}
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              <p className="text-gray-900 font-medium">Seher Admin</p>
